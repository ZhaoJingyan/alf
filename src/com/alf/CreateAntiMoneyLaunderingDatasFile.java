...
public class CreateAntiMoneyLaunderingDatasFile {
     ...
     * @throws ClassNotFoundException 找不到实现接口CellFormat的对象
     * @throws IllegalAccessException 反射错误
     * @throws InstantiationException 反射错误
     */
	 ...
	 * 初始化反洗格式配置文件。
	 * 
	 * @throws ClassNotFoundException 找不到单元格式类
	 * @throws IllegalAccessException 反射错误
	 * @throws InstantiationException 反射错误
	 */
	...
	/**
	 * 存储被调用的方法，和该方法的执行序号。 实现了Comparable接口，实现List<SequenceCell>的排序。
	 * 
	 * @author Zhao Jinyan
	 *
	 */
	 ...
	 * 
	 * @param data 反洗钱数据
	 * @throws InvocationTargetException 反射调动错误
	 * @throws IllegalArgumentException 反射调动错误
	 * @throws IllegalAccessException 反射调动错误
	 */
